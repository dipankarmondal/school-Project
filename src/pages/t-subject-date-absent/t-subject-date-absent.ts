...
@IonicPage()
@Component({
  selector: 'page-t-subject-date-absent',
  templateUrl: 't-subject-date-absent.html',
})
export class TSubjectDateAbsentPage {
  teacher: any;
  attendenceList: any;
  date: DateTime;
  subjectId:any;
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad TSubjectDateAbsentPage');
  }
